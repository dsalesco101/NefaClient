	...
	private void renderObject(int y, WorldController worldController, CollisionMap class11, int type, int z, int x,
		...
		if (type == 10 || type == 11) {
			...
			if (definition.aBoolean767 && class11 != null)
				class11.method212(definition.aBoolean757, definition.anInt744, definition.anInt761, x, y, orientation);
			return;
		}
		if (type >= 12) {
			Object obj2;
	...
	public static void method188(WorldController worldController, int orientation, int y, int type, int plane, CollisionMap class11,
		...
		if (type == 10 || type == 11) {
			...
			if (obj1 != null) {
				...
				int i5;
				if (orientation == 1 || orientation == 3) {
					k4 = definition.anInt761;
					i5 = definition.anInt744;
				} else {
					k4 = definition.anInt744;
					i5 = definition.anInt761;
				}
