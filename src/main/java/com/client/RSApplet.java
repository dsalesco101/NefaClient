	...
	public void mouseWheelMoved(MouseWheelEvent event) {
		...
		if (mouseX > 0 && mouseX < 512 && mouseY > Client.currentGameHeight - 165
			...
			if (zoom && Client.openInterfaceID == -1) {
				...
				int max_zoom_1 = (Client.currentScreenMode == ScreenMode.FIXED ? -400 : -300);
...
**/
	...
	public void windowClosing(WindowEvent windowevent) {
		...
		int userPrompt = JOptionPane.showOptionDialog(null, "Are you sure you wish to exit?", "NefariousPkz",
