...
//	}
	public static void cataTele(TextDrawingArea[] tda) {
		...
		addClickableText(33903, "Abyssal Demon", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33904, "Ankou", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33905, "Black Demons", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33906, "Bronze Dragon", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33907, "Brutal Black Dragon", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33908, "Brutal Blue Dragon", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33909, "Brutal Red Dragon", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33910, "Cyclops", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33911, "Dagannoth", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33912, "Dust Devil", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33913, "Deviant Spectre", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33914, "Fire Giant", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33915, "Ghost", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33916, "Greater Demon", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33917, "Greater Nechryael", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33918, "Hellhound", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33919, "Hill Giant", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33920, "Iron Dragon", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33921, "Mutated Bloodveld", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33922, "King Sand Crab", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33923, "Magic Axe", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33924, "Moss Giant", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33925, "Mutated Bloodveld", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33926, "Possessed Pickaxe", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33927, "Steel Dragon", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33928, "Shade", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33929, "Skeleton", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33930, "Twisted Banshee", "Teleport", tda, 1, 0xff9933, true, true, 0);
		addClickableText(33931, "Warped Jelly", "Teleport", tda, 1, 0xff9933, true, true, 0);
		
		inter.totalChildren(31);
		setBounds(33901, 15, 15, 0, inter);
		setBounds(33902, 250, 19, 1, inter);
		setBounds(33903, 100, 50, 2, inter);
		setBounds(33904, 100, 70, 3, inter);
		setBounds(33905, 100, 90, 4, inter);
		setBounds(33906, 100, 110, 5, inter);
		setBounds(33907, 100, 130, 6, inter);
		setBounds(33908, 100, 150, 7, inter);
		setBounds(33909, 100, 170, 8, inter);
		setBounds(33910, 100, 190, 9, inter);
		setBounds(33911, 100, 210, 10, inter);
		setBounds(33912, 100, 230, 11, inter);
		setBounds(33913, 250, 50, 12, inter);
		setBounds(33914, 250, 70, 13, inter);
		setBounds(33915, 250, 90, 14, inter);
		setBounds(33916, 250, 110, 15, inter);
		setBounds(33917, 250, 130, 16, inter);
		setBounds(33918, 250, 150, 17, inter);
		setBounds(33919, 250, 170, 18, inter);
		setBounds(33920, 250, 190, 19, inter);
		setBounds(33921, 250, 210, 20, inter);
		setBounds(33922, 250, 230, 21, inter);
		setBounds(33923, 400, 50, 22, inter);
		setBounds(33924, 400, 70, 23, inter);
		setBounds(33925, 400, 90, 24, inter);
		setBounds(33926, 400, 110, 25, inter);
		setBounds(33927, 400, 130, 26, inter);
		setBounds(33928, 400, 150, 27, inter);
		setBounds(33929, 400, 170, 28, inter);
		setBounds(33930, 400, 190, 29, inter);
		setBounds(33931, 400, 210, 30, inter);
